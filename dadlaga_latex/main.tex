...
\title{Үйлдвэрлэлийн дадлагын тайлан}
% Дипломын ажлын англи нэр
\titleEng{Unitel Group}
...
% Зэргийн нэр
\degreeName{Дадлагын тайлан}
% Суралцаж буй хөтөлбөрийн нэр
\programeName{Компьютерын Ухааны (D061301)}
% Хэвлэгдсэн газар
...
\begin{thebibliography}{}
    ...
    \bibitem{table}
    Tables, Share LaTex, \url{https://www.sharelatex.com/learn/Tables}
\end{thebibliography}
